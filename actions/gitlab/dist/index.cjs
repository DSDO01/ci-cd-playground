...
module.exports =
{
  parallel      : __nccwpck_require__(543),
  serial        : __nccwpck_require__(528),
...
var defer = __nccwpck_require__(966);
...
var async = __nccwpck_require__(862)
  , abort = __nccwpck_require__(236)
  ;
...
var abort = __nccwpck_require__(236)
  , async = __nccwpck_require__(862)
  ;
...
var iterate    = __nccwpck_require__(408)
  , initState  = __nccwpck_require__(992)
  , terminator = __nccwpck_require__(249)
  ;
...
var DelayedStream = __nccwpck_require__(508);
...
var debug = __nccwpck_require__(760);
...
var CombinedStream = __nccwpck_require__(52);
var util = __nccwpck_require__(23);
...
var Stream = (__nccwpck_require__(203).Stream);
var mime = __nccwpck_require__(494);
var asynckit = __nccwpck_require__(630);
var populate = __nccwpck_require__(609);
...
var db = __nccwpck_require__(279)
...
// EXTERNAL MODULE: ../../../../.nvm/versions/node/v20.6.1/lib/node_modules/@vercel/ncc/dist/ncc/@@notfound.js?axios
var _notfoundaxios = __nccwpck_require__(233);
...
class SecurityScan {
    ...
    async triggerScan(scanPayload) {
        try {
            const response = await (0,_notfoundaxios.post)(`${this.dedgeHostUrl}/integrations/scan-process`, scanPayload, {
                headers: {
    ...
    async pollScanResults(scanId) {
        try {
            while (true) {
                const response = await (0,_notfoundaxios.get)(`${this.dedgeHostUrl}/integrations/scan-process/${scanId}`, {
                    headers: {
                        'X-API-Key': this.apiToken
                    }
                });
...
/* harmony default export */ const common = (SecurityScan);

// EXTERNAL MODULE: ../common/helper.js
var helper = __nccwpck_require__(654);
...
var form_data = __nccwpck_require__(540);
...
var proxy_from_env = __nccwpck_require__(775);
...
var follow_redirects = __nccwpck_require__(295);
...
async function run() {
    try {
        ...
        const scan = new common(apiToken, dedgeHostUrl); // Create an instance of SecurityScan
        ...
        const triggerScanSuccessMessage = (0,helper.displayTriggerScanSuccessMessage)();
        ...
        try {
            ...
            messageScanResult = (0,helper.displayScanResultMessage)(result, reportLink);
...
async function postCommentOnMergeRequest(message, token) {
    ...
    try {
        await (0,node_modules_axios_namespaceObject.post)(`https://gitlab.com/api/v4/projects/${projectId}/merge_requests/${mergeRequestIid}/notes`, {
            body: message
        }, {
            headers: {
                'PRIVATE-TOKEN': token,
