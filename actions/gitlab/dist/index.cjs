...
var SecurityScan, common_default;
...
// index.js
var SecurityScan2 = (init_common(), __toCommonJS(common_exports)).default;
...
function run() {
  return __async(this, null, function* () {
    try {
      ...
      const scan = new SecurityScan2(apiToken, dedgeHostUrl, axios);
      let scanPayload = {
