...
module.exports =
{
  parallel      : __nccwpck_require__(194),
  serial        : __nccwpck_require__(629),
  serialOrdered : __nccwpck_require__(736)
};
...
var defer = __nccwpck_require__(41);
...
var abort = __nccwpck_require__(559)
...
var serialOrdered = __nccwpck_require__(736);
...
var DelayedStream = __nccwpck_require__(633);
...
var debug = __nccwpck_require__(663);
...
var CombinedStream = __nccwpck_require__(965);
var util = __nccwpck_require__(23);
...
var Stream = (__nccwpck_require__(203).Stream);
var mime = __nccwpck_require__(565);
var asynckit = __nccwpck_require__(453);
var populate = __nccwpck_require__(822);
...
var db = __nccwpck_require__(834)
...
var form_data = __nccwpck_require__(685);
...
var proxy_from_env = __nccwpck_require__(356);
...
var follow_redirects = __nccwpck_require__(24);
...
class SecurityScan {
    ...
    async triggerScan(scanPayload) {
        try {
            const response = await lib_axios.post(`${this.dedgeHostUrl}/integrations/scan-process/start`, scanPayload, {
                headers: {
    ...
    async pollScanResults(scanId) {
        try {
            while (true) {
                const response = await lib_axios.get(`${this.dedgeHostUrl}/integrations/scan-process/${scanId}`, {
                    headers: {
                        'X-API-Key': this.apiToken
                    }
                });
...
;// CONCATENATED MODULE: ../common/helper.js
